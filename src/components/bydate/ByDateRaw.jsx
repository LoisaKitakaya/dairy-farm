...
import ByDateVisualized from "./ByDateVisualize";

const ByDateRaw = ({ param }) => {
  if (!import.meta.env.VITE_REACT_APP_RECORDS_BY_DATE) {
    console.warn("endpoint not defined");
  }

  const url = import.meta.env.VITE_REACT_APP_RECORDS_BY_DATE;
            ...
            <>
              {data.data.records.length > 0 ? (
                <>
                  ...
                  <br />
                  <ByDateVisualized records={tableData} />
                </>
              ) : (
                <>
